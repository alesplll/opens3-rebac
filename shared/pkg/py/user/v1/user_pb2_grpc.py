...
class UserV1Stub(object):
    ...
    def __init__(self, channel):
        ...
        self.ValidateCredentials = channel.unary_unary(
                '/user_v1.UserV1/ValidateCredentials',
                request_serializer=user__pb2.ValidateCredentialsRequest.SerializeToString,
                response_deserializer=user__pb2.ValidateCredentialsResponse.FromString,
                _registered_method=True)
...
def add_UserV1Servicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ValidateCredentials': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=user__pb2.ValidateCredentialsRequest.FromString,
                    response_serializer=user__pb2.ValidateCredentialsResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'user_v1.UserV1', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('user_v1.UserV1', rpc_method_handlers)
...
class UserV1(object):
    ...
    def ValidateCredentials(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/user_v1.UserV1/ValidateCredentials',
            user__pb2.ValidateCredentialsRequest.SerializeToString,
            user__pb2.ValidateCredentialsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
