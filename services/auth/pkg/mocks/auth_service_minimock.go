...
//go:generate minimock -i github.com/alesplll/opens3-rebac/services/auth/internal/service.AuthService -o auth_service_minimock.go -n AuthServiceMock
...
type AuthServiceMock struct {
	...
	funcValidateToken          func(ctx context.Context, s1 string) (err error)
	inspectFuncValidateToken   func(ctx context.Context, s1 string)
...
func (mmLogin *mAuthServiceMockLogin) Expect(ctx context.Context, s1 string, s2 string) *mAuthServiceMockLogin {
	...
	mmLogin.defaultExpectation.params = &AuthServiceMockLoginParams{ctx, s1, s2}
...
func (mmLogin *mAuthServiceMockLogin) Inspect(f func(ctx context.Context, s1 string, s2 string)) *mAuthServiceMockLogin {
...
func (mmLogin *mAuthServiceMockLogin) Return(s3 string, err error) *AuthServiceMock {
	if mmLogin.mock.funcLogin != nil {
		mmLogin.mock.t.Fatalf("AuthServiceMock.Login mock is already set by Set")
	}
	...
	mmLogin.defaultExpectation.results = &AuthServiceMockLoginResults{s3, err}
	return mmLogin.mock
}

// Set uses given function f to mock the AuthService.Login method
func (mmLogin *mAuthServiceMockLogin) Set(f func(ctx context.Context, s1 string, s2 string) (s3 string, err error)) *AuthServiceMock {
	if mmLogin.defaultExpectation != nil {
...
// Then helper
func (mmLogin *mAuthServiceMockLogin) When(ctx context.Context, s1 string, s2 string) *AuthServiceMockLoginExpectation {
	if mmLogin.mock.funcLogin != nil {
		mmLogin.mock.t.Fatalf("AuthServiceMock.Login mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockLoginExpectation{
		mock:   mmLogin.mock,
		params: &AuthServiceMockLoginParams{ctx, s1, s2},
	}
...
func (e *AuthServiceMockLoginExpectation) Then(s3 string, err error) *AuthServiceMock {
	e.results = &AuthServiceMockLoginResults{s3, err}
	return e.mock
}

// Login implements service.AuthService
func (mmLogin *AuthServiceMock) Login(ctx context.Context, s1 string, s2 string) (s3 string, err error) {
	...
	mm_params := AuthServiceMockLoginParams{ctx, s1, s2}
	...
	if mmLogin.LoginMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockLoginParams{ctx, s1, s2}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmLogin.t.Fatalf("Unexpected call to AuthServiceMock.Login. %v %v %v", ctx, s1, s2)
	return
}
...
func (mmValidateToken *mAuthServiceMockValidateToken) Expect(ctx context.Context, s1 string) *mAuthServiceMockValidateToken {
	...
	mmValidateToken.defaultExpectation.params = &AuthServiceMockValidateTokenParams{ctx, s1}
...
func (mmValidateToken *mAuthServiceMockValidateToken) Inspect(f func(ctx context.Context, s1 string)) *mAuthServiceMockValidateToken {
...
func (mmValidateToken *mAuthServiceMockValidateToken) Return(err error) *AuthServiceMock {
	if mmValidateToken.mock.funcValidateToken != nil {
		mmValidateToken.mock.t.Fatalf("AuthServiceMock.ValidateToken mock is already set by Set")
	}
	...
	mmValidateToken.defaultExpectation.results = &AuthServiceMockValidateTokenResults{err}
	return mmValidateToken.mock
}

// Set uses given function f to mock the AuthService.ValidateToken method
func (mmValidateToken *mAuthServiceMockValidateToken) Set(f func(ctx context.Context, s1 string) (err error)) *AuthServiceMock {
	if mmValidateToken.defaultExpectation != nil {
...
// Then helper
func (mmValidateToken *mAuthServiceMockValidateToken) When(ctx context.Context, s1 string) *AuthServiceMockValidateTokenExpectation {
	if mmValidateToken.mock.funcValidateToken != nil {
		mmValidateToken.mock.t.Fatalf("AuthServiceMock.ValidateToken mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockValidateTokenExpectation{
		...
		params: &AuthServiceMockValidateTokenParams{ctx, s1},
	}
...
func (e *AuthServiceMockValidateTokenExpectation) Then(err error) *AuthServiceMock {
	e.results = &AuthServiceMockValidateTokenResults{err}
	return e.mock
}

// ValidateToken implements service.AuthService
func (mmValidateToken *AuthServiceMock) ValidateToken(ctx context.Context, s1 string) (err error) {
	...
	if mmValidateToken.inspectFuncValidateToken != nil {
		mmValidateToken.inspectFuncValidateToken(ctx, s1)
	}

	mm_params := AuthServiceMockValidateTokenParams{ctx, s1}
	...
	if mmValidateToken.ValidateTokenMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockValidateTokenParams{ctx, s1}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmValidateToken.t.Errorf("AuthServiceMock.ValidateToken got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
	...
	if mmValidateToken.funcValidateToken != nil {
		return mmValidateToken.funcValidateToken(ctx, s1)
	}
	mmValidateToken.t.Fatalf("Unexpected call to AuthServiceMock.ValidateToken. %v %v", ctx, s1)
	return
}
...
func (m *AuthServiceMock) MinimockValidateTokenDone() bool {
	...
	// if default expectation was set then invocations count should be greater than zero
	if m.ValidateTokenMock.defaultExpectation != nil && mm_atomic.LoadUint64(&m.afterValidateTokenCounter) < 1 {
		return false
	}
	// if func was set then invocations count should be greater than zero
	if m.funcValidateToken != nil && mm_atomic.LoadUint64(&m.afterValidateTokenCounter) < 1 {
		return false
	}
	return true
}
...
func (m *AuthServiceMock) MinimockValidateTokenInspect() {
	for _, e := range m.ValidateTokenMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to AuthServiceMock.ValidateToken with params: %#v", *e.params)
		}
	}
	...
	if m.ValidateTokenMock.defaultExpectation != nil && mm_atomic.LoadUint64(&m.afterValidateTokenCounter) < 1 {
		if m.ValidateTokenMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to AuthServiceMock.ValidateToken")
		} else {
			m.t.Errorf("Expected call to AuthServiceMock.ValidateToken with params: %#v", *m.ValidateTokenMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcValidateToken != nil && mm_atomic.LoadUint64(&m.afterValidateTokenCounter) < 1 {
