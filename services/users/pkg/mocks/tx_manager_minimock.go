...
//go:generate minimock -i github.com/alesplll/opens3-rebac/shared/pkg/kit/client/db.TxManager -o tx_manager_minimock.go -n TxManagerMock
...
import (
	...
	mm_db "github.com/alesplll/opens3-rebac/shared/pkg/kit/client/db"
