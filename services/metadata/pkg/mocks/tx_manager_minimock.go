...
//go:generate minimock -i github.com/alesplll/opens3-rebac/shared/pkg/go-kit/client/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/alesplll/opens3-rebac/shared/pkg/go-kit/client/db"
