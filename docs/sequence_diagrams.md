...
Статус: **проект полного Gateway и межсервисных сценариев**. Реализован только
локальный PUT/GET через Metadata и Storage; Auth/AuthZ, квота и Kafka cleanup в
этом HTTP-контуре отсутствуют. SD-12 описывает текущий AuthZ Check;
