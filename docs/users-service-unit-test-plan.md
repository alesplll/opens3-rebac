...
> **Архивный план ветки на 2026-04-02.** Перечисленные test files уже присутствуют
> в текущем checkout. Используйте правила `AGENTS.md` и фактический набор
> `services/users/internal/service/user/tests`; этот документ сохраняется как
> исходный scope, а не как список ещё невыполненной работы.
