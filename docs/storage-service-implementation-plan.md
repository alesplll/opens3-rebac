...
5. **После Фазы 4:** E2E тесты через gRPC
6. **Фаза 5+:** см. [distributed-storage-architecture.md](distributed-storage-architecture.md) и [kubernetes-deployment-plan.md](kubernetes-deployment-plan.md)
