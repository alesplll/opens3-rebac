...
Статус политики на 11 сентября 2026: **предложение для реализации**. Минимальный
Gateway PUT/GET теперь описан в [README сервиса](../services/gateway/README.md),
но политика Auth/AuthZ/Quota из этого документа ещё не реализована.
